    ...
    <section className="py-20 px-4">
      <AnimateOnScroll animation="fade-up">
        <div className="container mx-auto max-w-6xl">
          <div className="bg-gradient-to-r from-examfit-blue to-examfit-purple rounded-2xl p-10 md:p-16 text-white text-center relative overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  size="lg" 
                  className="bg-white text-examfit-blue hover:bg-white/90 hover:scale-105 transition-transform duration-300"
                >
                  Start Free Trial
                </Button>
                <Button 
